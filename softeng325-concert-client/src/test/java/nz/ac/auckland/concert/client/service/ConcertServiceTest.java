...
public class ConcertServiceTest {
	...
	@Test
	public void testRetrievePerformerImage() {

		Set<PerformerDTO> performers = _service.getPerformers();
		Set<Image> images = new HashSet<>();
		for (PerformerDTO performer : performers) {
		    if (!performer.getName().equals("Twenty One Pilots")) { // this image is buggy
                images.add(_service.getImageForPerformer(performer));
            }
		}
	}
